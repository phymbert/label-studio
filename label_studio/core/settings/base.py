...
OIDC_SERVER_URL = get_env('OIDC_SERVER_URL')
OIDC_CLAIMS_GROUP = get_env('OIDC_CLAIMS_GROUP')
OIDC_SCOPES = get_env('OIDC_SCOPES', 'openid email profile')
OIDC_TIMEOUT = float(get_env('OIDC_TIMEOUT', 5))
OIDC_ALLOWED_EMAIL_DOMAINS = get_env_list('OIDC_ALLOWED_EMAIL_DOMAINS', default=[])
OIDC_ALLOWED_GROUPS = get_env_list('OIDC_ALLOWED_GROUPS', default=[])
OIDC_CLAIM_EMAIL = get_env('OIDC_CLAIM_EMAIL', 'email')
OIDC_CLAIM_GIVEN_NAME = get_env('OIDC_CLAIM_GIVEN_NAME', 'given_name')
OIDC_CLAIM_FAMILY_NAME = get_env('OIDC_CLAIM_FAMILY_NAME', 'family_name')
OIDC_ORGANIZATION_TITLE = get_env('OIDC_ORGANIZATION_TITLE', 'Label Studio')
...
GUARDRAILS = get_bool_env('GUARDRAILS', False)
